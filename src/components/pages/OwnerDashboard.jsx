          ...
          >
            ...
            >
              <div className="px-6 py-4 border-b border-[#E4E8EF] flex items-center justify-between">
                ...
                <button className="hover:opacity-70 transition-opacity" onClick={() => setSelectedVehicle(null)}>
                  ...
                  <div>
                    ...
                    <p
                      style={{
                        ...
                        fontSize: '15px',
                        fontWeight: 600,
                        color: parseInt(selectedVehicle.serviceDue, 10) <= 7 ? '#E53935' : '#27AE60',
                      }}
                    >
            ...
            >
              <div className="px-8 py-6 border-b border-[#E4E8EF] flex items-center justify-between sticky top-0 bg-white rounded-t-[20px]">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="hover:opacity-70 transition-opacity" onClick={() => setDetailVehicle(null)}>
                        ...
                        <div>
                          ...
                          <p
                            style={{
                              ...
                              fontSize: '15px',
                              fontWeight: 600,
                              color: parseInt(vehicle.serviceDue, 10) <= 7 ? '#E53935' : '#27AE60',
                            }}
                          >
                            {vehicle.serviceDue}
                          </p>
                          ...
                          <div className="space-y-3">
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                <Shield
                                  className="w-4 h-4"
                                  style={{ color: getComplianceColor(vehicle.insurance.status) }}
                                />
                                <span
                                  style={{
                                    fontFamily: 'Inter',
                              ...
                              >
                                ...
                                {vehicle.insurance.daysRemaining > 0
                                  ? `(${vehicle.insurance.daysRemaining} days)`
                                  : '(Expired)'}
                              </p>
                            </div>
                            ...
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                <FileCheck
                                  className="w-4 h-4"
                                  style={{ color: getComplianceColor(vehicle.pollution.status) }}
                                />
                                <span
                                  style={{
                                    fontFamily: 'Inter',
                              ...
                              >
                                {vehicle.pollution.expiryDate}{' '}
                                {vehicle.pollution.daysRemaining > 0
                                  ? `(${vehicle.pollution.daysRemaining} days)`
                                  : '(Expired)'}
                              </p>
                            </div>
                            ...
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                <CircleDot
                                  className="w-4 h-4"
                                  style={{ color: getComplianceColor(vehicle.fitness.status) }}
                                />
                                <span
                                  style={{
                                    fontFamily: 'Inter',
                            ...
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                <Receipt
                                  className="w-4 h-4"
                                  style={{ color: getComplianceColor(vehicle.tax.status) }}
                                />
                                <span
                                  style={{
                                    fontFamily: 'Inter',
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex gap-6">
              ...
              >
                Live
                {activeTab === 'live' && (
                  <div className="absolute bottom-0 left-0 right-0 bg-[#0D47A1]" style={{ height: '2px' }} />
                )}
              </button>
              <button
            ...
            {vehicles
              ...
              .map((vehicle) => (
                ...
                >
                  ...
                  <ChevronRight className="w-[18px] h-[18px] flex-shrink-0" style={{ color: '#9AA3B2' }} />
                </div>
              ))}
          </div>
        </div>
