...
export function SupervisorDashboard({ onNavigate, selectedVehicleId }) {
  ...
  const [detailPopupVehicle, setDetailPopupVehicle] = useState(null);
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Vehicle Status Counter Popup - Top Center */}
      <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-30">
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl px-4 py-2 flex items-center gap-4">
          <div className="flex items-center gap-2">
            <Circle className="w-3 h-3" style={{ color: '#27AE60' }} />
            <span className="text-xs text-slate-700 font-medium">Moving: {vehicleCounts.moving}</span>
          </div>
          <div className="flex items-center gap-2">
            <Circle className="w-3 h-3" style={{ color: '#F2B233' }} />
            <span className="text-xs text-slate-700 font-medium">Idling: {vehicleCounts.idling}</span>
          </div>
          <div className="flex items-center gap-2">
            <Circle className="w-3 h-3" style={{ color: '#E53935' }} />
            <span className="text-xs text-slate-700 font-medium">Stopped: {vehicleCounts.stopped}</span>
          </div>
        </div>
      </div>

      {/* Right Panel - Vehicle List */}
      <div className="absolute inset-y-0 right-0 w-[340px] bg-white border-l border-[#E1E6EF] z-20 flex flex-col">
        {/* Header */}
        <div className="px-4 py-3 border-b border-[#E4E8EF] flex items-center justify-between">
          <div>
            <h2
              style={{
                fontFamily: 'Inter',
            ...
            >
              {vehicleCounts.all} Vehicles
            </p>
          </div>
          <div className="flex gap-2">
            <button className="w-8 h-8 rounded-lg border border-[#E1E6EF] flex items-center justify-center hover:bg-slate-50">
              <Share2 className="w-4 h-4" style={{ color: '#67727E' }} />
            </button>
            <button className="w-8 h-8 rounded-lg border border-[#E1E6EF] flex items-center justify-center hover:bg-slate-50">
              <Filter className="w-4 h-4" style={{ color: '#67727E' }} />
            </button>
            <button className="w-8 h-8 rounded-lg border border-[#E1E6EF] flex items-center justify-center hover:bg-slate-50">
              <Download className="w-4 h-4" style={{ color: '#67727E' }} />
            </button>
          </div>
        </div>

        {/* Tabs */}
        <div className="px-4 py-2 flex items-center gap-2 border-b border-[#E4E8EF]">
          <button
            ...
            <div
              ...
              className={`rounded-[12px] border cursor-pointer transition-all ${
                selectedVehicle?.id === vehicle.id
                  ? 'border-[#0D47A1] bg-[#E8F1FF] shadow-sm'
                  : 'border-[#E1E6EF] bg-white hover:bg-slate-50'
              }`}
            >
              <div className="px-3 py-2.5 flex items-center gap-3">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span
                      ...
                      style={{
                        ...
                        fontWeight: 600,
                        color: '#FFFFFF',
                        backgroundColor: getManufacturerColor(vehicle.manufacturer)
                      }}
                    >
                ...
                <ChevronRight className="w-4 h-4 flex-shrink-0" style={{ color: '#C0C6D4' }} />
              </div>
            </div>
          ))}
        </div>
